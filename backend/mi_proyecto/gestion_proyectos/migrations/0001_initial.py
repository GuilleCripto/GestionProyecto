# Generated by Django 5.2.6 on 2025-09-07 23:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('administrador', 'Administrador'), ('colaborador', 'Colaborador'), ('visor', 'Visor')], default='visor', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proyecto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tareas', to='gestion_proyectos.proyecto')),
            ],
        ),
        migrations.CreateModel(
            name='Comentario',
            fields=[
                ...
                ('tarea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comentarios', to='gestion_proyectos.tarea')),
            ],
        ),
    ]
